...
export default function Aurora(props) {
  ...
  useEffect(() => {
    ...
    gl.canvas.style.display = "block"; // Ensure it doesn't have inline gaps

    let animateId;
    const update = (t) => {
      animateId = requestAnimationFrame(update);

      // Use the speed prop to scale the time uniform
  ...
  return (
    <div
      ...
      style={{ minHeight: "100vh", position: "relative", zIndex: 50 }}
    />
  );
}
